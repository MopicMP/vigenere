...
[![PyPI version](https://badge.fury.io/py/vigenere.svg)](https://pypi.org/project/vigenere/)
...
# Basic usage
result = vigenere("your input here")
print(result)
```
...
result = vigenere("Hello World")

# Example 2: Batch processing
from vigenere import batch
